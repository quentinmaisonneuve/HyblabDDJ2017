	  ...
	  if(id=="Galerie")
		{
			...
			if(id=="Carroussel")
			{
				...
				{
					if(nombrezero<2){
						d3.select(this).selectAll('#path-Carroussel').style('opacity', '0.5');
						d3.select(this).selectAll('.legend-label-carroussel').style('opacity', '0.5');
						legend3=0;
						chart.toggle(id);
					}
				}
				...
				{
					d3.select(this).selectAll('#path-Carroussel').style('opacity', '1');
					d3.select(this).selectAll('.legend-label-carroussel').style('opacity', '1');
					legend3=1;
					chart.toggle(id);
				}
			}
