function showPresse2014() {
	var idfond='fondpresse2014',
		idcrayon='crayonpresse2014',
		idtitre='titrepresse2014',
		idtexte='textepresse2014',
		iddate='datepresse2014';
	var widthfond='20vw',
		heightfond='24vh',
		widthcrayon='10%',
		heightcrayon='10%',
		...
		text='<div id="'+idtexte+'">&laquo; 2ème année que l\'on profite du voyage à Nantes ... et toutes les étapes sont à faire !! &raquo;</div>',
		titre='<div id="'+idtitre+'">visiteur anonyme '+svgcrayon+'</br><div id="'+iddate+'">23 Juillet 2014</div></div>';
	
	d3.select('#presse2014').style('width',widthfond).style('height',heightfond).html(text+""+titre);
	setTimeout(function(){ $("#presse2014").css("display", "block"); }, 1000);
}
function hidePresse2014() {
	$("#presse2014").css("display", "none");
}
