...
var data = {
    ...
    {
         return db.query("SELECT count(*), _genre4 FROM winmedia_media W LEFT JOIN musique_auditeur_tbl M ON M.id_musique = W._jazler_id WHERE  _genre4 <>''AND _genre4<>'Classique' AND _genre4<>'Bande originale' AND _genre4<>'Musique traditionnelle' AND _genre4 <>'Autres' AND (DAYOFYEAR(date_heure_diffusion_reelle) < 80 OR DAYOFYEAR(date_heure_diffusion_reelle) >= 355) GROUP BY _genre4;", callback)
    },
    // Get occurency of each music genre during Spring
    getSpringGenre:function(callback)
    {
        return db.query("SELECT count(*), _genre4 FROM winmedia_media W LEFT JOIN musique_auditeur_tbl M ON M.id_musique = W._jazler_id WHERE  _genre4 <>''AND _genre4<>'Classique' AND _genre4<>'Bande originale' AND _genre4<>'Musique traditionnelle' AND _genre4 <>'Autres' AND DAYOFYEAR(date_heure_diffusion_reelle) >= 80 AND DAYOFYEAR(date_heure_diffusion_reelle) < 172 GROUP BY _genre4;", callback)
    },
    // Get occurency of each music genre during Summer
    getSummerGenre:function(callback)
    {
        return db.query("SELECT count(*), _genre4 FROM winmedia_media W LEFT JOIN musique_auditeur_tbl M ON M.id_musique = W._jazler_id WHERE  _genre4 <>''AND _genre4<>'Classique' AND _genre4<>'Bande originale' AND _genre4<>'Musique traditionnelle' AND _genre4 <>'Autres' AND DAYOFYEAR(date_heure_diffusion_reelle) >= 172 AND DAYOFYEAR(date_heure_diffusion_reelle) < 264 GROUP BY _genre4;", callback)
    },
    // Get occurency of each music genre during Autumn
    getAutumnGenre:function(callback)
    {
        return db.query("SELECT count(*), _genre4 FROM winmedia_media W LEFT JOIN musique_auditeur_tbl M ON M.id_musique = W._jazler_id WHERE _genre4 <>''AND _genre4<>'Classique' AND _genre4<>'Bande originale' AND _genre4<>'Musique traditionnelle' AND _genre4 <>'Autres' AND DAYOFYEAR(date_heure_diffusion_reelle) >= 264 AND DAYOFYEAR(date_heure_diffusion_reelle) < 355 GROUP BY _genre4;", callback)
    },
    ...
    getCreneau:function(start, stop, callback)
    {
        if (!valideDate(start) || !valideDate(stop))
            ...
            return db.query("SELECT count(*), _genre4 FROM winmedia_media W LEFT JOIN musique_auditeur_tbl M ON M.id_musique = W._jazler_id WHERE _genre4 <>''AND _genre4<>'Classique' AND _genre4<>'Bande originale' AND _genre4<>'Musique traditionnelle' AND _genre4 <>'Autres' AND date_heure_diffusion_reelle >=  '"+ start+"' AND date_heure_diffusion_reelle <= '"+ stop +"' GROUP BY _genre4;", callback)
    ...
    getCreneauSeasonWeek:function(season, week, callback)
    {
        ...
        if (week == 0) // Week
            ...
            return db.query("SELECT count(*) AS value, _genre4 AS id FROM winmedia_media W LEFT JOIN musique_auditeur_tbl M ON M.id_musique = W._jazler_id WHERE _genre4 <>''AND _genre4<>'Classique' AND _genre4<>'Bande originale' AND _genre4<>'Musique traditionnelle' AND _genre4 <>'Autres' AND ("+intervalle+") AND (DAYOFWEEK(date_heure_diffusion_reelle)>='0' OR DAYOFWEEK(date_heure_diffusion_reelle)<='6') GROUP BY _genre4;", callback)
        //return db.query("SELECT count(*), _genre4 FROM winmedia_media W LEFT JOIN musique_auditeur_tbl M ON M.id_musique = W._jazler_id WHERE DAYOFYEAR(date_heure_diffusion_reelle) < DAYOFYEAR(NOW()) AND DAYOFYEAR(date_heure_diffusion_reelle) >= (DAYOFYEAR(NOW())-1) GROUP BY _genre4;", callback)
    },
    ...
    getCreneauSeasonWeekHourMood:function(season, week, start, end, callback)
    {
        var intervalle = "";
        switch(season)
        {
        ...
        if (week == 0) // Week
            return db.query("SELECT count(*) AS value, _mood1 AS id FROM winmedia_media W LEFT JOIN musique_auditeur_tbl M ON M.id_musique = W._jazler_id WHERE ("+intervalle+") AND WEEKDAY(date_heure_diffusion_reelle)<='4' AND HOUR(date_heure_diffusion_reelle)>='"+start+"' AND HOUR(date_heure_diffusion_reelle)<='"+end+"'  GROUP BY _mood1;", callback)
        else if (week == 1) // Week End
            return db.query("SELECT count(*) AS value, _mood1 AS id FROM winmedia_media W LEFT JOIN musique_auditeur_tbl M ON M.id_musique = W._jazler_id WHERE ("+intervalle+") AND WEEKDAY(date_heure_diffusion_reelle)>='5' AND HOUR(date_heure_diffusion_reelle)>='"+start+"' AND HOUR(date_heure_diffusion_reelle)<='"+end+"' GROUP BY _mood1;", callback)
        //return db.query("SELECT count(*), _genre4 FROM winmedia_media W LEFT JOIN musique_auditeur_tbl M ON M.id_musique = W._jazler_id WHERE DAYOFYEAR(date_heure_diffusion_reelle) < DAYOFYEAR(NOW()) AND DAYOFYEAR(date_heure_diffusion_reelle) >= (DAYOFYEAR(NOW())-1) GROUP BY _genre4;", callback)
    },
